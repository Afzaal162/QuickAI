    ...
    return (
     ...
     bg-[url(/gradientBackground.png)]
      bg-cover bg-no-repeat min-h-screen'>
            ...
            md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]'>Create Amazing Content
                    <br /> <span className='text-primary'> With the Help of AI</span></h1>
                <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl 
            m-auto max-sm:text-xs text-gray-600'>Transform your content creation with our suite of Premium AI Tools.
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
                ...
                active:scale-95 transition cursor-pointer'>Creating Now</button>
                <button className='bg-white px-10 py-3 border border-gray-300 rounded-lg hover:scale-102 
