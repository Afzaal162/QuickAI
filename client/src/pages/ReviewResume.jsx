...
import { Sparkle, File, FileText } from 'lucide-react'
  ...
  return (
    <div className=' overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='text-xs text-gray-500 font-light mt-1'>Supports PDF File Only</p>
        {/* <br /> */}
    ...
    rounded-lg flex flex-col border border-gray-200 min-h-96">
        ...
        {!content ?(<div className="flex-1 flex justify-center items-center">
          <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
            <FileText className='w-9 h-5 text-[#00DA83]' />
            <p>Upload the Resume & Get the Desired Results</p>
          </div>
        </div>):(
